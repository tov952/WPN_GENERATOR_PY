...
def genGunpartParmTemplates(gunpartName, gunpartNiceName, validLayerName):
    hou_parm_template = hou.FolderParmTemplate("numOf_"+ gunpartName, "Num Of "+gunpartNiceName, folder_type=hou.folderType.TabbedMultiparmBlock, default_value=0, ends_tab_group=False)
    # Code for parameter template
    hou_parm_template2 = hou.FolderParmTemplate(gunpartName+"#", gunpartNiceName, folder_type=hou.folderType.Tabs, default_value=0, ends_tab_group=False)
    # Code for parameter template
