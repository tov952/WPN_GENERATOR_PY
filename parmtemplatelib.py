...
def createPTG():
    ...
    # Code for parameter template
    hou_parm_template3 = hou.FloatParmTemplate("xthicknessFactor", "X-Thickness Factor", 1, default_value=([1]), min=0, max=1, min_is_strict=True, max_is_strict=True, look=hou.parmLook.Regular, naming_scheme=hou.parmNamingScheme.Base1)
